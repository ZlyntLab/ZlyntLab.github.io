      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Every project is an opportunity to explore new possibilities and adquire new skills.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              { value: "15+", label: "Projects", sublabel: "Internacional portfolio", direction: "right" },
              { value: "5", label: "Years", sublabel: "Of experience", direction: "left" },
              +
