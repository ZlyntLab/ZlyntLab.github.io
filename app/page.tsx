...
import { FormationSection } from "@/components/sections/formation-section"
      ...
      >
        ...
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-foreground/15 backdrop-blur-md transition-all duration-300 hover:scale-110 hover:bg-foreground/25">
            <span className="font-sans text-xl font-bold text-foreground">I</span>
          </div>
          <span className="font-sans text-xl font-semibold tracking-tight text-foreground">Ivanft</span>
        </button>

        <div className="hidden items-center gap-8 md:flex">
          {["Home", "Work", "Education", "About", "Contact"].map((item, index) => (
            <button
              key={item}
        ...
        <section className="flex min-h-screen w-screen shrink-0 flex-col justify-end px-6 pb-16 pt-24 md:px-12 md:pb-24">
          <div className="max-w-3xl">
            <div className="mb-4 inline-block animate-in fade-in slide-in-from-bottom-4 rounded-full border border-foreground/20 bg-foreground/15 px-4 py-1.5 backdrop-blur-md duration-700">
              <p className="font-mono text-xs text-foreground/90">Azure, ASP.NET Core, React, TypeScript, C#</p>
            </div>
            ...
            <p className="mb-8 max-w-xl animate-in fade-in slide-in-from-bottom-4 text-lg leading-relaxed text-foreground/90 duration-1000 delay-200 md:text-xl">
              <span className="text-pretty">
                I am a software engineer focused on building robust and secure end-to-end solutions. Passionate about research and development, I enjoy exploring new technologies and creating innovative digital experiences.
              </span>
            </p>
          </div>
